...
export const RWANDAN_FOOD_PRESETS: RwandanFoodPreset[] = [
  ...
  {
    id: 'protein-4',
    name: 'Ground Nut Sauce',
    category: 'protein',
    calories: 300,
    portion: '1 cup',
    localLanguage: 'Ibisosa',
    createdAt: new Date().toISOString()
  },
  {
    id: 'protein-5',
...
export function calculateTDEE(
  ...
  const bmr =
    88.362 + 13.397 * (weightLbs * 0.453592) + 4.799 * (heightInches * 2.54) - 5.677 * age;
