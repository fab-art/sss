        ...
        <AnimatePresence mode="popLayout">
          {mealEntries.length === 0 ? (
            <motion.button
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="rounded-[2.5rem] border border-dashed border-white/10 p-12 w-full flex flex-col items-center justify-center gap-4 group hover:bg-white/[0.02] hover:border-primary/30 transition-all focus:outline-none focus:ring-2 focus:ring-primary/20 bg-white/[0.01]"
            >
              <div className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center group-hover:scale-110 transition-transform">
                <Plus className="w-6 h-6 text-zinc-500 group-hover:text-primary transition-colors" />
              </div>
              <p className="text-zinc-600 font-medium group-hover:text-zinc-400 transition-colors">
                No data logged for today. Tap to fuel up.
              </p>
            </motion.button>
          ) : (
                  ...
                  >
                      <div className="flex justify-between items-center mb-8">
                        ...
                        <button
                          ...
                          className="p-2 bg-white/5 rounded-full hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-primary/20 transition"
                        >
                          <X className="w-5 h-5" />
                        </button>
                      </div>
              ...
              >
                  <header className="p-6 flex justify-between items-center border-b border-white/5">
                      <button
                        ...
                        className="p-2 hover:bg-white/5 rounded-full focus:outline-none focus:ring-2 focus:ring-primary/20 transition"
                      >
                        <X className="w-6 h-6" />
                      </button>
