...
export function NutritionTracker() {
  const { mealEntries, removeMeal, logMeal, foodPresets, getSuggestions, protocol, getSummary } =
    useNutritionStore();
      ...
      <header className="flex justify-between items-end px-2">
        ...
        <div className="text-right">
          ...
          <p className="text-xl font-black text-white">
            {totalCalories} <span className="text-xs text-zinc-500">kcal</span>
          </p>
        </div>
      </header>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="font-black text-white">
              {protocol?.eatingWindowStart} – {protocol?.eatingWindowEnd}
            </p>
          </div>
        </div>
        <div className="text-right">
          <p className="text-[10px] font-black text-primary uppercase tracking-widest">
            {protocol?.protocolType || '16:8'} ACTIVE
          </p>
        </div>
      </div>
            ...
            mealEntries.map((meal) => (
              ...
              >
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <div className="font-black text-white text-lg capitalize tracking-tight">
                      {meal.mealType}
                    </div>
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-[2rem] p-6">
                  ...
                  {suggestions.length > 0 ? (
                    ...
                    <p className="text-sm text-zinc-300 font-medium">
                      Keep it up! Your nutrition is optimized for today.
                    </p>
                  )}
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-zinc-900 rounded-[2rem] p-6 border border-white/5 shadow-inner">
                    ...
                    <p className="text-xs text-zinc-500 font-medium mb-6">
                      Matoke, Grilled Chicken, Spinach, Beans
                    </p>
                    <button
                      onClick={async () => {
                        const comboFoods = [
                  ...
                  {foodPresets.map((preset) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          className={`w-8 h-8 rounded-xl flex items-center justify-center transition-colors ${isSelected ? 'bg-primary text-black' : 'bg-white/5 text-zinc-700'}`}
                        >
                          {isSelected ? (
              ...
              <div className="flex justify-between items-center mb-8">
                ...
                <div className="text-right">
                  ...
                  <p className="text-3xl font-black text-primary tracking-tighter">
                    {selectedFoods.reduce((s, f) => s + f.calories, 0)}{' '}
