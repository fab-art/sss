      ...
      <div className="space-y-4">
        ...
        <AnimatePresence mode="popLayout">
          {mealEntries.length === 0 ? (
            ...
            >
              <div className="w-12 h-12 rounded-2xl bg-zinc-900 border border-white/5 flex items-center justify-center text-zinc-500 group-hover:scale-110 transition-transform">
                <Plus className="w-6 h-6" />
              </div>
              <span className="text-sm font-bold uppercase tracking-widest">No data logged for today.</span>
              <span className="text-[10px] font-black text-primary uppercase tracking-[0.2em] opacity-0 group-hover:opacity-100 transition-opacity">Initiate Fueling</span>
            </motion.button>
          ) : (
                          ...
                          <div className="space-y-4">
                              ...
                              <div className="bg-zinc-900 rounded-[2rem] p-6 border border-white/5 shadow-inner">
                                  ...
                                  <button
                                    ...
                                    disabled={isLogging}
                                    className="w-full py-3 rounded-xl bg-primary text-black font-black text-[10px] uppercase tracking-widest shadow-lg shadow-primary/20 disabled:opacity-50 flex items-center justify-center gap-2"
                                  >
