              ...
              >
                  ...
                  >
                      <div className="flex justify-between items-center mb-8">
                        ...
                        <button onClick={() => setShowSuggestions(false)} aria-label="Close suggestions modal" className="p-2 bg-white/5 rounded-full hover:bg-white/10 transition"><X className="w-5 h-5" /></button>
                      </div>
          ...
          {showLogModal && (
              ...
              >
                  <header className="p-6 flex justify-between items-center border-b border-white/5">
                      <button onClick={() => setShowLogModal(false)} aria-label="Close log fuel modal" className="p-2 hover:bg-white/5 rounded-full transition"><X className="w-6 h-6" /></button>
