        ...
        <AnimatePresence mode="popLayout">
          {mealEntries.length === 0 ? (
            <motion.button
              ...
              className="w-full rounded-[2.5rem] border border-dashed border-white/10 p-12 text-center text-zinc-600 bg-white/[0.01] hover:bg-white/5 hover:border-primary/30 transition-all group"
            >
              <Plus className="w-8 h-8 mx-auto mb-4 text-zinc-800 group-hover:text-primary transition-colors" />
