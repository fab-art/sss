          ...
          <div className="rounded-[2rem] bg-zinc-900 border border-white/5 p-6 space-y-4 shadow-xl">
              ...
              <div className="flex gap-2">
                  <button
                    ...
                    className="w-full py-2 bg-primary/10 text-primary rounded-xl text-[10px] font-black uppercase hover:bg-primary/20 transition flex items-center justify-center gap-1.5 min-h-[32px]"
                  >
