        ...
        <div className="w-full space-y-8">
            ...
            <div className="text-center space-y-2">
                <div className="flex items-baseline justify-center gap-2">
                    <input
                        type="number"
                        aria-label={(exerciseType === 'walking' || exerciseType === 'footsteps') ? "Manual steps entry" : "Manual distance entry"}
    ...
    <section className="max-w-xl mx-auto min-h-screen bg-black text-white flex flex-col p-6 pb-24 font-sans">
      ...
      <header className="flex justify-between items-center mb-8">
        <button
            ...
            aria-label={view === 'exercise' ? "Return to exercise list" : "Reload quest"}
