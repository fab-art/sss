    ...
    <section className="space-y-10 pb-24 font-sans">
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-primary font-black uppercase tracking-[0.3em] text-[10px] mt-2 italic">
            {rank.title} • Division {progression.level}
          </p>
        </div>
      </div>
        ...
        <div className="bg-zinc-900 border border-white/5 rounded-[3rem] p-10 space-y-6 shadow-2xl">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-5">
              <div className="w-12 h-12 rounded-2xl bg-primary text-black flex items-center justify-center font-black text-lg italic shadow-lg shadow-primary/20">
                1
              </div>
              <div>
            ...
            <div className="flex items-center gap-5 opacity-40 grayscale">
              <div className="w-12 h-12 rounded-2xl bg-zinc-800 text-zinc-600 flex items-center justify-center font-black text-lg italic border border-white/5">
                2
              </div>
              <div>
                <p className="font-black text-zinc-400 uppercase italic tracking-tight">Guardian</p>
                <p className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">
                  Requires 7 quests won
                </p>
              </div>
            </div>
          </div>
