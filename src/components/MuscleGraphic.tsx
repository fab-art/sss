...
// Optimization: Memoize the component with a custom comparison function.
// This prevents expensive SVG re-renders when the muscle growth values are identical,
// even if a new object reference is passed by the parent.
export const MuscleGraphic = memo(MuscleGraphicBase, (prevProps, nextProps) => {
  return (
