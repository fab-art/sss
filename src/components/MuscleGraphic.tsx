...
/**
 * Performance optimization: Memoize the complex SVG component to prevent redundant re-renders
 * when parent components (like Dashboard) update state that doesn't affect muscle growth.
 * Performs a shallow check on all MuscleGrowth properties.
 */
