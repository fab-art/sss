...
export const MuscleGraphic = memo(function MuscleGraphic({ growth }: { growth: MuscleGrowth }) {
  ...
  // BOLT OPTIMIZATION: Prevent expensive SVG re-renders by shallow checking growth properties.
  // This is critical because parent components often create new growth object references on every render.
